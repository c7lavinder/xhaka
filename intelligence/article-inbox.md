...
- [Reverse Engineering Claude Code] 213MB Bun binary, 9.88MB minified JS extracted, 15+ modular system prompt sections assembled at runtime, 597 internal feature flags (tengu_ namespace). HIGH PRIORITY — pairs with leaked Claude Code 2.0 prompt analysis already in KB. Wednesday setup.
