...
Current State: The xhaka-control-room service is in a crash loop, redeploying every minute due to a Railway crash. This is causing significant disruption, with APIs returning 404 errors. Immediate attention is required to check Railway logs and resolve the underlying issue.
## 2026-03-21 (100 commits)
### 🔄 Changed
- chore: job-registry [heartbeat-check=running]
- chore: results-log [operator=success]
- chore: job-registry [operator=success]
- chore: operator-log [cleanup=rollback]
- chore: job-registry [operator=running]
- chore: results-log [dispatcher=success]
- chore: job-registry [dispatcher=success]
- chore: operator-log [improve=rollback]
