...
## Auto-Generated Rules (2026-03-15)

- [HIGH][RULE]: Always use `gemini-pro` for sub-agents unless model availability is verified.
- [HIGH][RULE]: Install tools locally within the workspace and alias them as needed; avoid global installations.
- [HIGH][RULE]: Persist any state data to Railway environment variables or a database, as the disk is ephemeral.
- [HIGH][RULE]: Delegate any code tasks greater than one line to specialized agents like The Builder.
...
- [RULE]: Ensure all communications reflect Xhaka's identity and tone as per SOUL.md; avoid generic AI phrases.
...
- [RULE]: Use creation-time triggers for data hygiene processes to catch fast-moving stage changes, rather than relying on stage-current triggers.
