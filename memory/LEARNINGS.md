...
## Auto-Generated Rules (2026-04-20)

- [HIGH][RULE]: Sub-agents must default to using `gemini-pro` unless another model is verified to be available.
- [RULE]: Always install tools locally within the workspace to avoid permission issues.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral; persist state to the database or environment variables.
- [HIGH][RULE]: Delegate any code tasks greater than one line to The Builder to ensure efficiency and accuracy.
- [RULE]: Sub-agents operate in a sandbox; use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to actual repository paths.
- [RULE]: Maintain a consistent identity and tone as outlined in SOUL.md; avoid generic AI phrases.
- [RULE]: Before enabling any features, ensure no individual ENGINE_* environment variables override the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for data hygiene processes to accommodate fast-moving stage changes in workflows.


## Auto-Generated Rules (2026-04-21)

- [HIGH][RULE]: Always default sub-agents to `gemini-pro` unless another model's availability is verified.
- [RULE]: Install tools locally within the workspace using `npm install` and alias them as needed.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral. Persist state to a database or environment variables.
- [RULE]: For any code task longer than one line, spawn the specialized Builder agent to handle it.
- [RULE]: Sub-agents operate in a sandbox. Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to actual repository paths.
- [RULE]: Maintain Xhaka's unique tone and identity as per SOUL.md; avoid generic AI phrases.
- [RULE]: Before enabling any feature, ensure no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Use creation-time triggers instead of stage-current triggers to account for fast-moving stage changes in workflows.


## Auto-Generated Rules (2026-04-22)

- [HIGH][RULE]: Sub-agents must default to using `gemini-pro` unless model availability is verified.
- [RULE]: Always install tools locally in the workspace using `npm install` and alias them as needed.
- [HIGH][RULE]: On Railway, treat disk as ephemeral; persist state to database or environment variables.
- [RULE]: For code tasks greater than one line, spawn a specialized agent like The Builder.
- [RULE]: Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for all operations involving writing to the real repository paths.
- [RULE]: Maintain Xhaka's identity and tone as per SOUL.md; avoid generic AI phrases.
- [RULE]: Before enabling any feature, ensure no individual ENGINE_* environment variables override the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for data hygiene processes to account for fast-moving stage changes in workflows.


## Auto-Generated Rules (2026-04-23)

- [HIGH][RULE]: Sub-agents should default to using `gemini-pro` unless a specific model is verified to be available.
- [HIGH][RULE]: Always install tools locally in the workspace to avoid permission issues.
- [RULE]: On Railway, treat the disk as ephemeral; persist state to the database or environment variables instead.
- [HIGH][RULE]: For any code task longer than one line, spawn The Builder to handle it.
- [RULE]: Sub-agents operate in a sandbox; use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to actual repository paths.
- [RULE]: Avoid generic AI phrases; maintain Xhaka's distinct identity and tone as outlined in SOUL.md.
- [RULE]: Before enabling any feature, ensure no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Use creation-time triggers instead of stage-current triggers to handle fast-moving stage changes effectively.


## Auto-Generated Rules (2026-04-24)

- [HIGH][RULE]: Sub-agents must default to `gemini-pro` unless model availability is verified.
- [RULE]: Always install tools locally in the workspace using `npm install` and alias them as needed.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral. Persist state to the database or environment variables.
- [RULE]: For any code task exceeding one line, spawn the specialized Builder agent.
- [RULE]: Sub-agents operate in a sandbox; use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to actual repository paths.
- [RULE]: Adhere to the identity and tone standards outlined in SOUL.md to maintain Xhaka's unique voice.
- [RULE]: Before enabling features, ensure no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for polling to account for fast-moving stage changes in workflows.


## Auto-Generated Rules (2026-04-25)

- [HIGH][RULE]: Sub-agents must default to `gemini-pro` unless another model is verified as available.
- [RULE]: Always install tools locally in the workspace using `npm install` and alias them if needed.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral; persist state to the database or environment variables.
- [RULE]: Delegate any coding tasks longer than one line to the Builder or Architect agents.
- [RULE]: Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for all file operations in the actual repository paths.
- [HIGH][RULE]: Maintain Xhaka's unique tone and identity; avoid generic AI phrases.
- [RULE]: Before enabling any feature, verify that no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for data hygiene to account for fast-moving stage changes in workflows.


## Auto-Generated Rules (2026-04-26)

- [HIGH][RULE]: Sub-agents must default to using `gemini-pro` unless another model is verified to be available.
- [RULE]: Always install tools locally within the workspace using `npm install` and alias them as needed.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral; persist state to the database or environment variables instead.
- [RULE]: Delegate any coding tasks longer than one line to a specialized agent, such as The Builder.
- [RULE]: Sub-agents operate in a sandbox environment; use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to actual repository paths.
- [RULE]: Avoid using generic AI phrases; adhere to the identity and tone standards outlined in SOUL.md to maintain Xhaka's distinct voice.
- [RULE]: Before enabling any feature, ensure no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Use creation-time triggers instead of stage-current triggers to handle fast-moving stage changes effectively.


## Auto-Generated Rules (2026-04-27)

- [HIGH][RULE]: Sub-agents must default to using `gemini-pro` unless model availability is verified first.
- [RULE]: Always install tools locally within the workspace using `npm install` and alias them as needed.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral; persist state to the database or environment variables.
- [RULE]: For any code task exceeding one line, delegate to The Builder by spawning a specialized agent.
- [HIGH][RULE]: Ensure sub-agents operate in a sandbox environment, and use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to real repository paths.
- [RULE]: Maintain Xhaka's unique identity and tone in all communications; avoid generic AI phrases.
- [HIGH][RULE]: Before enabling any feature, verify that no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for data hygiene processes to account for fast-moving stage changes, rather than relying solely on current stage triggers.


## Auto-Generated Rules (2026-04-28)

- [HIGH][RULE]: Always verify model availability before attempting to run sub-agents. Default to using `gemini-pro` if unsure.
- [RULE]: Install all tools locally within the workspace and alias them as needed, avoiding global installations.
- [HIGH][RULE]: On Railway, persist any state data to environment variables or a database, as the disk is ephemeral.
- [RULE]: Delegate any code tasks exceeding one line to specialized agents like The Builder.
- [RULE]: Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for all file operations in the repository to ensure they are written to the correct paths.
- [RULE]: Maintain Xhaka's distinct tone and identity in all communications, avoiding generic AI phrases.
- [RULE]: Before enabling any features, ensure no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Implement creation-time triggers for data hygiene processes to account for fast-moving stage changes, rather than relying solely on current-stage triggers.


## Auto-Generated Rules (2026-04-29)

- [HIGH][RULE]: Sub-agents must default to `gemini-pro` unless model availability is verified.
- [RULE]: Always install tools locally in the workspace using `npm install` and alias them as needed.
- [HIGH][RULE]: On Railway, treat disk as ephemeral; persist state to the database or environment variables.
- [RULE]: Delegate all code tasks greater than one line to specialized agents like The Builder.
- [RULE]: Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for all file operations in the repository to ensure correct path usage.
- [RULE]: Maintain Xhaka's identity and tone as outlined in SOUL.md; avoid generic AI phrases.
- [RULE]: Before enabling any feature, verify that no individual ENGINE_* environment variables override the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for data hygiene processes to accommodate fast-moving stage changes in workflows.


## Auto-Generated Rules (2026-04-30)

- [HIGH][RULE]: Sub-agents must default to using `gemini-pro` unless model availability is verified.
- [RULE]: Always install tools locally within the workspace to avoid permission issues.
- [HIGH][RULE]: On Railway, treat disk storage as ephemeral; persist state to environment variables or a database.
- [RULE]: For any code task exceeding one line, spawn a specialized Builder agent to handle it.
- [RULE]: Sub-agents operate in a sandbox environment; use the Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for writing to actual repository paths.
- [RULE]: Ensure communication aligns with Xhaka's identity and tone as specified in SOUL.md; avoid generic AI phrases.
- [RULE]: Before enabling any feature, confirm that no individual ENGINE_* environment variables override the global DRY_RUN flag.
- [RULE]: Use creation-time triggers for data processes to account for fast-moving stage changes, rather than relying solely on stage-current triggers.


## Auto-Generated Rules (2026-05-01)

- [HIGH][RULE]: Sub-agents must default to using `gemini-pro` unless the model's availability is verified first.
- [HIGH][RULE]: Always install tools locally within the workspace using `npm install` and alias them as needed.
- [RULE]: On Railway, treat the disk as ephemeral; persist all state to the database or environment variables.
- [HIGH][RULE]: For any code task exceeding one line, spawn a specialized agent, such as The Builder, to handle it.
- [RULE]: Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for all file operations in the actual repository to ensure files are written to the correct paths.
- [RULE]: Maintain Xhaka's distinct identity and tone in all communications; avoid generic AI phrases.
...
## Auto-Generated Rules (2026-05-03)

- [HIGH][RULE]: Always verify model availability before attempting to run sub-agents. Default to using `gemini-pro` if the model is not specified or unavailable.
- [RULE]: Install all tools locally within the workspace using `npm install` and alias them as needed; avoid global installations.
- [RULE]: On Railway, treat disk storage as ephemeral. Persist any necessary state to the database or environment variables.
- [HIGH][RULE]: Delegate any code tasks involving more than one line to specialized agents like The Builder. Do not manually edit code.
- [RULE]: Use Claude Code CLI (`npx -y @anthropic-ai/claude-code`) for any file operations that need to write directly to the repository paths, as sub-agents operate in a sandbox.
- [RULE]: Maintain the unique tone and identity of Xhaka as outlined in SOUL.md. Avoid using generic AI phrases.
- [RULE]: Before enabling any feature, ensure that no individual ENGINE_* environment variables are overriding the global DRY_RUN flag.
- [RULE]: Build triggers based on creation time rather than current stage to avoid missing fast-moving stage changes in workflows.
